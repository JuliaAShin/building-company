...
function displayResidential() {
    ...
    services_p2.innerHTML='Home security systems, outdoor lighting, and surveillance equipment.<br><p>Energy savings, exhaust fans, and residential generators</p>';
...
function displayIndustrial() {
    ...
    services_p2.innerHTML='24-hour customer service is an exciting challenge to solve. It typically means your business is expanding or you are taking on larger customers.';
    services_p3.innerHTML='';
    services_img.src='imgs/JS/industrial_js.jpg';
}

service_button[0].addEventListener('click', displayCommercial);
service_button[1].addEventListener('click', displayResidential);
service_button[2].addEventListener('click', displayIndustrial);
...
let reviewText = [
    '<p>We have had several good experiences with <span>Blue Collar</span> team. Most recently, they replaced our 20-year-old HVAC system with a new, <span>modern, and more efficient</span> system &amp; it worked fine.</p>',

    '<p>Goog Job!<br><br>Thanks.',

    'Excellent service.<br><br> Arrived in time.<br><br>Highly recommend.',

    'First Class Service, I recommend this company. In the future I will certainly use them again'
]
